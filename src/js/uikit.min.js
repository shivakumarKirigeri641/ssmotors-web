/*! UIkit 3.23.10 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */ (function (
  Se,
  Ie
) {
  ...
  const Ui = { ratio: qi, contain: Gs, cover: cr };
  ...
  function Zs(t, e = document, i) {
    ...
    return Te(e) || (e = e.ownerDocument), Gi(e, i, t);
  }
  function Gi(t, e, i) {
    try {
      return t[e](i);
  ...
  function es(t, e) {
    return E(
      E(t).map((i) => (i.hasChildNodes() ? Le(oe(i.childNodes), e) : W(i, e)))
    );
  }
  function We(t) {
    E(t)
  ...
  function as(t) {
    hs(t) && cs(t, { func: "playVideo", method: "play" }),
      ls(t) && t.play().catch(A);
  }
  function $i(t) {
    hs(t) && cs(t, { func: "pauseVideo", method: "pause" }), ls(t) && t.pause();
  }
  function pn(t) {
    hs(t) && cs(t, { func: "mute", method: "setVolume", value: 0 }),
      ls(t) && (t.muted = !0);
  }
  function ls(t) {
    return F(t, "video");
    ...
    function s(r, a, l, c) {
      return new Promise((u) => {
        ...
        (function Ct() {
          ...
          i[0] === r &&
            d + a < c &&
            (wt = C(l).top + (b ? 0 : r.scrollTop) - y - g(ds(l)).height),
            h(r, "scrollBehavior") !== "auto" && h(r, "scrollBehavior", "auto"),
            (r.scrollTop = d + (a + wt) * zt),
            h(r, "scrollBehavior", ""),
            zt === 1 && (P === wt || !it--)
              ? u()
              : ((P = wt), requestAnimationFrame(Ct));
        })();
      });
    }
    function n(r) {
  ...
  (V.events =
    ...
    (V.update = function (t, e) {
      return Vs(ms(t, ot(e) ? { read: e } : e), "order");
    }),
  ...
  function Kr(t) {
    return J(t)
      ? t
      : H(t)
      ? t.split(Jr).map((e) => (vt(e) ? $t(e) : ji(e.trim())))
      : [t];
  }
  function Zr(t) {
    (t._data = {}),
  ...
  function xs(t, e = !1) {
    ...
    return (
      e && ([i, s] = je(t)), { top: i, left: s, bottom: i + n, right: s + o }
    );
  }
        ...
        I(e, $s),
          await (s
            ? Promise.all(
                Mn(e).map(
                  async (d, f) => (
                    await Ss(f * s), M.start(d, r, i / 2, "ease")
                  )
                )
              )
  ...
  function ks(t, e) {
    return (
      e && (t.dataset.transition = 1 + ks(t)), $t(t.dataset.transition) || 0
    );
  }
  function On(t) {
    return Promise.all(
  ...
  var ua = {
    ...
    connected() {
      this.loading !== "lazy"
        ? this.load()
        : Es(this.$el) && ((this.$el.loading = "lazy"), Is(this.$el));
    },
    disconnected() {
  ...
  function Is(t, e) {
    ...
    } else e && !v(t.style.backgroundImage, e) && (h(t, "backgroundImage", `url(${Xi(e)})`), m(t, pe("load", !1)));
  }
  ...
  function fa(t, e, i) {
    const s = new Image();
    return (
      Wn(s, i), Ln(t, s), (s.onload = () => Is(t, s.currentSrc)), (s.src = e), s
    );
  }
  function Wn(t, e) {
    if (((e = pa(e)), e.length)) {
  ...
  async function ma(
    ...
    f && (h(t, y, se - it + Us), (rr[y] = e ? Us : se + Us)),
      !f ^ (l === "reveal") &&
        (h(Li, y, -se + it), M.start(Li, { [y]: e ? 0 : -se }, s, o));
    try {
  ...
  var Ia = {
    ...
    events: [
      ...
      { name: As, el: ({ list: t }) => t, handler: A, ...Ci },
    ],
    methods: {
      start() {
        (this.drag = this.pos),
      ...
      move(t) {
        ...
        if (
          (Vt(document, As, this.move, Ci),
          Vt(document, Gn, this.end, Yn),
          this.dragging)
        )
          if (
            (setTimeout(w(this.list, "click", (t) => t.preventDefault(), Ci)),
            (this.dragging = null),
  ...
  function _a(t) {
    t._hasComputed &&
      ...
      (t._computedObserver = rs(t.$el, () => Ve(t, "computed"), Kn)),
      t._disconnect.push(() => {
  ...
  (ht.util = Ur), (ht.options = {}), (ht.version = "3.23.10");
  const ja = "uk-",
    Zt = "__uikit__",
    xe = {};
  function so(t, e) {
  ...
  var ho = {
    ...
    co = {
      ...
      data: () => ({
        ...
        Animations: ho,
        template:
          '<div className="uk-lightbox uk-overflow-hidden"> <div className="uk-lightbox-items"></div> <div className="uk-position-top-right uk-position-small uk-transition-fade" uk-inverse> <button className="uk-lightbox-close uk-close-large" type="button" uk-close></button> </div> <div className="uk-lightbox-slidenav uk-position-center-left uk-position-medium uk-transition-fade" uk-inverse> <a href uk-slidenav-previous uk-lightbox-item="previous"></a> </div> <div className="uk-lightbox-slidenav uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse> <a href uk-slidenav-next uk-lightbox-item="next"></a> </div> <div className="uk-position-center-right uk-position-medium uk-transition-fade" uk-inverse style="max-height: 90vh; overflow: auto;"> <ul className="uk-lightbox-thumbnav uk-lightbox-thumbnav-vertical uk-thumbnav uk-thumbnav-vertical"></ul> <ul className="uk-lightbox-dotnav uk-dotnav uk-dotnav-vertical"></ul> </div> <div className="uk-lightbox-counter uk-text-large uk-position-top-left uk-position-small uk-transition-fade" uk-inverse></div> <div className="uk-lightbox-caption uk-position-bottom uk-text-center uk-transition-slide-bottom uk-transition-opaque"></div> </div>',
      }),
      created() {
      ...
      methods: {
        ...
        setItem(t, e) {
          m(this.$el, "itemloaded", [this, bt(this.getSlide(t), e)]);
        },
        getSlide(t) {
    ...
    created() {
      const t = `${this.clsContainer}-${this.pos}`,
        ...
        i =
          ...
          W(
            this.container,
            `<div className="${this.clsContainer} ${t}" ${e}></div>`
          );
      this.$mount(
        W(
          i,
          `<div className="${this.clsMsg}${
            this.status ? ` ${this.clsMsg}-${this.status}` : ""
          }" role="alert"> <a href className="${
            this.clsClose
      ...
      (s, n) => {
        const [o, r, a] = yo(i, n),
          l = o
            .map(
              (c, u) => (
                (c += a * (r[u] - c)), u === 3 ? S(c) : parseInt(c, 10)
              )
            )
            .join(",");
        s[t] = `rgba(${l})`;
    ...
    return {
      ...
      show(u, d = 0, f) {
        ...
        return (
          ...
          M.start(o, { transform: j(-a * (U ? -1 : 1), "px") }, u, p).then(
            c,
            A
          ),
          l
      ...
      translate(u) {
        ...
        h(
          o,
          "transform",
          j(K(-a + (d - d * u), -ke(o), g(o).width) * (U ? -1 : 1), "px")
        );
  ...
  function Di(t, e) {
    return (
      (t && (is(t).left + (U ? g(t).width - g(e).width : 0)) * (U ? -1 : 1)) ||
      0
    );
  }
  function _o(t, e) {
  ...
  var Pl = {
    ...
    methods: {
      ...
      async _show(t, e) {
        (this.tooltip = W(
          this.container,
          `<div id="${e}" className="uk-${this.$options.name}" role="tooltip"> <div className="uk-${this.$options.name}-inner">${t}</div> </div>`
        )),
  ...
  function Hl(t) {
    ...
    for (const {
      ...
      const r = o && Ho(o);
      r && (Pt(n, o) ? Ke(r, n) : (e = Ti(n, r)) == null || e.$destroy());
    }
  }
  function Fo(t) {
    const e = Ze(t);
      ...
      be({
        ...
        handler([{ isIntersecting: t }]) {
          document.fullscreenElement ||
            (t ? this.autoplay && as(this.$el) : $i(this.$el));
        },
        args: { intersecting: !1 },
  ...
  var lh = {
    ...
    mh =
      '<svg width="12" height="12" viewBox="0 0 12 12"><polyline fill="none" stroke="#000" stroke-width="1.1" points="1 3.5 6 8.5 11 3.5"/></svg>',
    vh =
      '<svg width="20" height="20" viewBox="0 0 20 20"><style>.uk-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.uk-navbar-toggle-icon svg&gt;.line-3{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.uk-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width="20" height="2" y="3" className="line-1"/><rect width="20" height="2" y="9" className="line-2"/><rect width="20" height="2" y="9" className="line-3"/><rect width="20" height="2" y="15" className="line-4"/></svg>',
    bh =
    ...
    Xo = {
      ...
      disconnected() {
        this.svg.then((t) => {
          this._connected ||
            (Vi(this.$el) && (this.$el.hidden = !1), Q(t), (this.svgEl = null));
        }),
          (this.svg = null);
      },
  ...
  function qh(t) {
    return (
      (t = Rh[t] || t),
      zi[t]
        ? (Fi[t] || (Fi[t] = Ko(zi[Uh(t)] || zi[t])), Fi[t].cloneNode(!0))
        : null
    );
  }
  function Uh(t) {
  ...
  var Xh = {
      ...
      connected() {
        [this.wrapper] = es(this.$el, `<span className="${this.clsWrapper}">`);
      },
      disconnected() {
  ...
  function Kh({ modal: t }) {
    (t.dialog = function (i, s) {
      const n = t(x(`<div><div className="uk-modal-dialog">${i}</div></div>`), {
        stack: !0,
        role: "alertdialog",
        ...s,
      });
        ...
        return e(
          ({ i18n: n }) =>
            `<div className="uk-modal-body">${
              H(i) ? i : bt(i)
            }</div> <div className="uk-modal-footer uk-text-right"> <button className="uk-button uk-button-primary uk-modal-close" type="button" autofocus>${
              n.ok
            }</button> </div>`,
          s
        );
      ...
      (t.confirm = function (i, s) {
        return e(
          ({ i18n: n }) =>
            `<form> <div className="uk-modal-body">${
              H(i) ? i : bt(i)
            }</div> <div className="uk-modal-footer uk-text-right"> <button className="uk-button uk-button-default uk-modal-close" type="button">${
              n.cancel
            }</button> <button className="uk-button uk-button-primary" autofocus>${
              n.ok
            }</button> </div> </form>`,
          s,
          () => Promise.reject()
      ...
      (t.prompt = function (i, s, n) {
        const o = e(
            ({ i18n: l }) =>
              `<form className="uk-form-stacked"> <div className="uk-modal-body"> <label>${
                H(i) ? i : bt(i)
              }</label> <input className="uk-input" autofocus> </div> <div className="uk-modal-footer uk-text-right"> <button className="uk-button uk-button-default uk-modal-close" type="button">${
                l.cancel
              }</button> <button className="uk-button uk-button-primary">${
                l.ok
              }</button> </div> </form>`,
            n,
            () => null,
      ...
      update: [
        {
          read() {
            ...
            if (s >= r) a = e - 1;
              ...
              const l = this.offset + g(ds()).height + o.height * 0.1;
              for (
                let c = 0;
      ...
      connected() {
        (this.start = er(this.start || this.top)),
          ...
          (this.placeholder =
            ...
            x('<div className="uk-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          this.setActive(!1);
      },
      beforeDisconnect() {
